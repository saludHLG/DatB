...
function _submitIndicacion() {
    ...
    if (_st.paciente?.id) {
        ...
        _savePacientes(pacientes);
        if (typeof sbUpsertRow === 'function') sbUpsertRow('pacientes', nuevo).catch(console.error);
    }
    ...
    if (typeof sbUpsertRow === 'function') sbUpsertRow('indicaciones_examen', nuevaInd).catch(console.error);
...
function _submitEdicion() {
    ...
    if (typeof sbUpsertRow === 'function') sbUpsertRow('indicaciones_examen', inds[idx]).catch(console.error);
